...
A puzzle game is a genre focused on logic, pattern recognition and problem-solving, challenging the player to complete objectives using reasoning rather than combat or reflexes.
